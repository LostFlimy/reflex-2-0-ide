...
public class ReflexParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ReflexGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInterruptedAccess().getGroup(), "rule__Interrupted__Group__0");
			...
			builder.put(grammarAccess.getProgramAccess().getVectorsAssignment_5_5(), "rule__Program__VectorsAssignment_5_5");
			builder.put(grammarAccess.getProgramAccess().getRegistersAssignment_5_6(), "rule__Program__RegistersAssignment_5_6");
			builder.put(grammarAccess.getProgramAccess().getBitsAssignment_5_7(), "rule__Program__BitsAssignment_5_7");
			builder.put(grammarAccess.getProgramAccess().getProcessesAssignment_5_8(), "rule__Program__ProcessesAssignment_5_8");
			...
			builder.put(grammarAccess.getProcessAccess().getInterruptedAssignment_5(), "rule__Process__InterruptedAssignment_5");
			builder.put(grammarAccess.getProcessAccess().getStatesAssignment_6(), "rule__Process__StatesAssignment_6");
			builder.put(grammarAccess.getInterruptedAccess().getVecAssignment_1(), "rule__Interrupted__VecAssignment_1");
			builder.put(grammarAccess.getInterruptedAccess().getRegAssignment_2(), "rule__Interrupted__RegAssignment_2");
			builder.put(grammarAccess.getInterruptedAccess().getBitAssignment_3(), "rule__Interrupted__BitAssignment_3");
			builder.put(grammarAccess.getInterruptedAccess().getStateFunctionAssignment_5(), "rule__Interrupted__StateFunctionAssignment_5");
			...
			builder.put(grammarAccess.getVectorAccess().getNameAssignment_1(), "rule__Vector__NameAssignment_1");
